...
var $lastList = $siteList.find('li.lastList');
...
render();
$('div.addButton').on('click', function () {
    //console.log(1) //测试点击生效
    var url = window.prompt('您想添加的网址是什么？');
...
//     e.stopPropagation()
// })
$('input.inputOn').addEventListener('focusin', function (e) {
    console.log('输入框焦点');
    e.stopPropagation();
...
//# sourceMappingURL=main.d0a0e2f0.map